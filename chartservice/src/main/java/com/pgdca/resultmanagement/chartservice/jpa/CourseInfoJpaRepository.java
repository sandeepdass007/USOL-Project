...
import com.pgdca.resultmanagement.chartservice.jdbc.entity.CourseInfo;


@Repository
public interface CourseInfoJpaRepository extends org.springframework.data.jpa.repository.JpaRepository<CourseInfo, String> {
